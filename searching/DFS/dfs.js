...
class bst {
    ...
    DfsInorder() {
        return traversalInorder(this.root, [])
    }
    Dfspreorder() {
        return traversalPreorder(this.root, [])
    }
    DfsPostorder() {
        return traversalPostorder(this.root, [])
    }
...
function traversalInorder(node,list){
    if(node.leftchild){
        traversalInorder(node.leftchild,list)
    }
    list.push(node.value)
    if(node.rightchild){
        traversalInorder(node.rightchild,list)
    }
    return list;

}
function traversalPreorder(node,list){
    list.push(node.value)
    if(node.leftchild){
        traversalPreorder(node.leftchild,list)
    }
    if(node.rightchild){
        traversalPreorder(node.rightchild,list)
    }
    return list;

}
function traversalPostorder(node,list){
    if(node.leftchild){
        traversalPostorder(node.leftchild,list)
    }
    if(node.rightchild){
        traversalPostorder(node.rightchild,list)
    }
    list.push(node.value)
    return list
